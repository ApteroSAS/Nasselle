...
import {TextField, Box, Button, ToggleButton, ToggleButtonGroup, Typography, Divider} from "@mui/material";
import {Code, ContentCopy, Refresh, ViewModule,Terminal,Window  } from "@mui/icons-material";
        ...
        return (
          <>
              <Typography style={styles.stepDescription}>
                  You already have a public key. You can either set a private key for configuration or regenerate a new key pair:
              </Typography>
